...
#' **NOTE**: the variable, `classification.ref.ITS` is assigned in the script `00.loading_packages.v2.R`
#' # set file path
path.6.phyloseq <- file.path(here("data", "6.phyloseq_on_R1_reads"))
...
seqtab <- read.csv(file.path(here("data", "4.dada", "2026-01-07SeqTable_chimeras_rm_R1.csv")))
beep("mario")
...
# 2026-01-08 - 14 samples and 11261 sequence variants
...
# 2026-01-08 - 11260 sequence variants (ASVs) and 7 taxonomic ranks
...
colnames(seqtab.ASVs)
# 20260108 no undetermined reads in dataset
