...
#' # set file path
path.7.figures <- file.path(here("data", "7.figures_on_merged_oomycete_ITS_trimmed"))
if(!dir.exists(path.7.figures)) dir.create(path.7.figures)

#' # Import data
load(here("data", "6.phyloseq_on_merged_oomycetes_ITS_trimmed", "species.abundance.RData"))
